...
import { ScrollView,StyleSheet ,RefreshControl,Text, View,Image,Dimensions,TextInput,TouchableOpacity, ToastAndroid } from 'react-native';
...
export default function Marcar_asistencia(props){
            ...
            data:registro,
                ...
                if (d.data==0) {
                    ...
                    setTimeout(() => {
                        setUusuario(datos);
                        ToastAndroid.showWithGravity(
                            'Se registro tu asistencia con exito !',
                            ToastAndroid.SHORT,
                            ToastAndroid.BOTTOM
                        );
                        setAcceder(false);
    ...
    <View style={marcar_asistencia.containerLogin} >
            ...
            <View style={marcar_asistencia.cuadro_biendenida}>
                <Image  style={marcar_asistencia.imagen_bienvenida} source={require('../assets/hora.png')}></Image>
            </View>
                ...
                <View style={marcar_asistencia.cuerpo_principal}>
                    <View style={marcar_asistencia.cuerpo_entrada}>
                        ...
                        <View style={marcar_asistencia.cuerpo_imagen}>
                            <Image  style={marcar_asistencia.imagen} source={require('../assets/working.png')}></Image>
                        </View>
                            ...
                            { 
                                ...
                                ?
                                    usuario.hora_ingreso < hora_de_ingreso ? 
                                        <Badge value={usuario.hora_ingreso}  status="success"  />
                                        :
                                        <Badge value={usuario.hora_ingreso}  status="error" />
                                :
                                <Text></Text>
                            }                         
                        </View>
                        <View style={marcar_asistencia.cuerpo_boton}>
                            {
                                ...
                                loading={acceder}
                                titleStyle={{ fontWeight: '200', fontSize: 14 }}
                                buttonStyle={{
                                ...
                                />
                                :
                                <Image  style={marcar_asistencia.imagen_check} source={require('../assets/correct.png')}></Image>
                    ...
                    <View style={marcar_asistencia.cuerpo_refrigerio}>
                        <View style={marcar_asistencia.cuerpo_imagen}>
                            <Image  style={marcar_asistencia.imagen} source={require('../assets/lunch.png')}></Image>

                        </View>
                        <View style={marcar_asistencia.cuerpo_texto}>
                            <Text>Horario de refrigerio</Text>
                            <Text>01:00 - PM</Text>
                            <Badge value={usuario.hora_refrigerio}  status="success" />
                    ...
                    <View style={marcar_asistencia.cuerpo_salida}>
                        <View style={marcar_asistencia.cuerpo_imagen}>
                            <Image  style={marcar_asistencia.imagen} source={require('../assets/salida.png')}></Image>

                            </View>
                            <View style={marcar_asistencia.cuerpo_texto}>
                                <Text>Horario de salida</Text>
                                <Text>05:00 - PM</Text>
                                <Badge value={usuario.hora_salida}  status="success" />
